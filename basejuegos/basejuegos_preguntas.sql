...
CREATE TABLE `preguntas` (
  ...
  `respuesta_correcta` enum('1','2','3') NOT NULL,
  `puntaje` int(11) NOT NULL DEFAULT '0',
  `id_tema` int(11) NOT NULL,
  PRIMARY KEY (`idpreguntas`),
  KEY `tema_pregunta_idx` (`id_tema`),
  CONSTRAINT `tema_pregunta` FOREIGN KEY (`id_tema`) REFERENCES `temas` (`idtemas`)
...
INSERT INTO `preguntas` VALUES (1,'como se llama san martin?','jose','juan','pedro','1',20,1);
